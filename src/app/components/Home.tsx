...
export default function Home() {
  return (
<<<<<<< HEAD
    <div className="flex flex-col items-center justify-center gap-10 pt-10 md:gap-16 md:pt-16 lg:flex-row lg:gap-24 lg:pt-20">
      <div className="flex flex-col items-center gap-5 text-center md:items-start md:text-left">
        <div className="mt-20 flex flex-col items-center justify-center gap-2 md:flex-row md:gap-3">
          ...
          <h1 className="rounded-2xl bg-white px-3 py-1 text-xl font-bold text-[#101557] md:text-3xl lg:text-4xl">
            CASIO
          </h1>
          <h1 className="text-xl font-bold text-white md:text-3xl lg:text-4xl">
            คืออะไร ?
        ...
        <p className="max-w-[250px] text-sm text-white md:max-w-[500px] md:text-lg lg:max-w-[600px] lg:text-2xl">
      ...
      <div>
        <Image
          ...
          height={300}
          alt="คุณสมบัติ"
          className="mt-10 h-[200px] w-[120px] rounded-2xl md:mt-16 md:h-[300px] md:w-[180px] lg:mt-20 lg:h-[500px] lg:w-[300px]"
        />
      </div>
=======
    <div className="flex flex-col items-center justify-center
      ...
      <div className="flex flex-col justify-center items-center md:items-start gap-5 text-center md:text-left">
        <div className="justify-center items-center mt-20 flex flex-col md:flex-row gap-2 md:gap-3">
          <h1 className="font-bold text-white text-4xl md:text-4xl lg:text-4xl">CALCTECH CAMP X</h1>
          <h1 className="rounded-2xl bg-white px-3 py-1 font-bold text-[#101557] text-4xl md:text-4xl lg:text-4xl">
            CASIO
          </h1>
          <h1 className="font-bold text-white text-4xl md:text-4xl lg:text-4xl">คืออะไร ?</h1>
        </div>
        <p className="max-w-[250px] text-md text-white 
...
>>>>>>> 79843d3942622aeba1e655cd2b23d0a98b222b81
    </div>
  );
}
